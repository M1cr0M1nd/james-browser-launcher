...
/**
 * Setup procedure for Safari browser:
...
/**
 * Setup procedure for IE browser:
 *  - only options
 * @param  {Object}   browser  Browser object
 * @param  {Object}   options  Configuration options
 * @param  {Function} callback Callback function
 */
setups.ie = function (browser, options, callback) {
  callback(null, options.options, []);
};
...
setups.chrome = function (browser, options, callback) {
  options.options = options.options || [];
  options.disableDefaults = options.disableDefaults || false;
  options.disableProfile = options.disableProfile || false;
  ...
  var defaults = (options.disableDefaults) ? [] : [
